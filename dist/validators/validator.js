...
exports.UserValidator = function (req, res, next) {
  ...
  req.check('username', 'Username must be more than 1 characters').isLength({
    min: 2
  });
  req.check('password', 'Password is required.').not().isEmpty();
  req.check('password', 'Password must be more than 6 characters').isLength({
    min: 6
  });
...
exports.ProjectValidator = function (req, res, next) {
  ...
  req.check('title_vi', 'Title VI must be more than 6 characters').isLength({
    min: 6
  });
  req.check('sapo_vi', 'Sapo VI must be more than 6 characters').isLength({
    min: 6
  });
  req.check('detail_vi', 'Detail VI must be more than 6 characters').isLength({
    min: 6
  });
  req.check('title_en', 'Title EN must be more than 6 characters').isLength({
    min: 6
  });
  req.check('detail_en', 'Detail EN must be more than 6 characters').isLength({
    min: 6
  });
  req.check('sapo_en', 'Sapo EN must be more than 6 characters').isLength({
    min: 6
  });
  const errors = req.validationErrors();
  if (errors) {
...
exports.PartnerValidator = function (req, res, next) {
  ...
  req.check('title', 'Title must be more than 3 characters').isLength({
    min: 3
  });
  const errors = req.validationErrors();
  if (errors) {
...
exports.RatingValidator = function (req, res, next) {
  ...
  req.check('name_vi', 'Name VI must be more than 6 characters').isLength({
    min: 3
  });
  req.check('review_en', 'Review VI must be more than 6 characters').isLength({
    min: 3
  });
  req.check('name_en', 'Name EN must be more than 6 characters').isLength({
    min: 3
  });
  req.check('review_en', 'Review EN must be more than 6 characters').isLength({
    min: 3
  });
  const errors = req.validationErrors();
  if (errors) {
